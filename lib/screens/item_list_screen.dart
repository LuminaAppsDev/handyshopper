...
/// Displays the items of the active list with "All" and "Need" tabs.
///
/// Pushed from the lists screen; the active list is already set on
/// [ListProvider] before navigation.
